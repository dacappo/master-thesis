...
\usepackage[table]{xcolor} 			% einfache Verwendung von Farben in nahezu allen Farbmodellen
...
\newcommand{\thesisSubtitle}{Investigating and Validation of NoSQL Injection Vulnerabilites}
...
\newcommand{\period}{01. April - 30. September 2016}
