...
\newcommand{\deadline}{November 7, 2016}
\newcommand{\period}{May 9 - November 8, 2016}
...
\definecolor{lighter-gray}{RGB}{247,247,247}
\definecolor{dark-blue}{RGB}{0, 35, 91}
...
\lstset{
  ...
  numberstyle=\tiny,
  upquote=true,
  linewidth=.97\textwidth
}

% Declare the \emph formatting
\DeclareTextFontCommand{\emph}{\ttfamily\small}

% Declare the caption formattings
...
% Declare the listing language JavaScript
...
\begin{onehalfspace}
  \include{content/statement} 				% Einbinden der eidestattlichen Erklärung
...
\begin{onehalfspace}                % Zeilenabstand einstellen
  ...
  \include{content/fundamentals}
  \include{content/conception}
  \include{content/attacks}
