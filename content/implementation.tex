...
The implemented driver is published as an open source project and can be be installed via the Node Package Manager. (https://www.npmjs.com/package/mongodb-secure)
