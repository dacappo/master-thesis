...
These are the three major means to encode semantics into a query. Consequently, an attacker has to take influence at least one of the three semantic encodings in order to compromise the targeted security goals.

\section{Analysis of Attacker Surface}
How the gap between attacker surface and influence on the given 
